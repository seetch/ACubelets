...
public class Animation15_Task extends Animation {
	...
	public void onStart() {
		...
		armorStand = ASSpawner.spawn(
				...
				XSkull.createItem().profile(new Profileable.StringProfileable("eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZTBlZTc4MWI3OWIxZmRjMTRhYzA4YjUwNDQ4Y2Q5MTc0ZjcxZTE1NTUxNmUzYmY1NDJhMmQ2YzQ2NmVhY2Y4MiJ9fX0=", ProfileInputType.BASE64)).apply(),
				false,
				false,
				true
		);
